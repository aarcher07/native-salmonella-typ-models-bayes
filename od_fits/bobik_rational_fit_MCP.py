...
plt.savefig('figures/bobik_MCP_rational_2_2_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.savefig('figures/bobik_MCP_rational_3_3_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.savefig('figures/bobik_MCP_rational_4_4_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.savefig('figures/bobik_MCP_rational_5_5_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.savefig('figures/bobik_MCP_rational_6_6_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.legend(['rational function', 'data'], loc='upper left')
plt.title('OD fit to rational function,' + r'$\frac{\sum_{i=0}^{n}p_ix^i}{1+\sum_{i=1}^{n}q_ix^i}$' + ', for $n = 2$')
plt.savefig('figures/bobik_MCP_rational_2_2_constrained_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.legend(['rational function', 'data'], loc='upper left')
plt.title('OD fit to rational function,' + r'$\frac{\sum_{i=0}^{n}p_ix^i}{1+\sum_{i=1}^{n}q_ix^i}$' + ', for $n = 3$')
plt.savefig('figures/bobik_MCP_rational_3_3_constrained_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.legend(['rational function', 'data'], loc='upper left')
plt.title('OD fit to rational function,' + r'$\frac{\sum_{i=0}^{n}p_ix^i}{1+\sum_{i=1}^{n}q_ix^i}$' + ', for $n = 4$')
plt.savefig('figures/bobik_MCP_rational_4_4_constrained_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.legend(['rational function', 'data'], loc='upper left')
plt.title('OD fit to rational function,' + r'$\frac{\sum_{i=0}^{n}p_ix^i}{1+\sum_{i=1}^{n}q_ix^i}$' + ', for $n = 5$')
plt.savefig('figures/bobik_MCP_rational_5_5_constrained_OD_fit.png', bbox_inches="tight")
plt.close()
...
plt.legend(['rational function', 'data'], loc='upper left')
plt.title('OD fit to rational function,' + r'$\frac{\sum_{i=0}^{n}p_ix^i}{1+\sum_{i=1}^{n}q_ix^i}$' + ', for $n = 6$')
plt.savefig('figures/bobik_MCP_rational_6_6_constrained_OD_fit.png', bbox_inches="tight")
plt.close()